...
public class EditActivity extends Activity implements TIMCallBack{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(timechat.fcgz.sj.time.R.layout.activity_edit);
        getIntent().getStringExtra("title");
        input = (EditText) findViewById(timechat.fcgz.sj.time.R.id.editContent);
        ...
        TemplateTitle title = (TemplateTitle) findViewById(timechat.fcgz.sj.time.R.id.editTitle);
    ...
    public void onError(int i, String s) {
        Toast.makeText(this,getResources().getString(timechat.fcgz.sj.time.R.string.edit_error),Toast.LENGTH_SHORT).show();
    }
