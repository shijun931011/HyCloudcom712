...
import timechat.fcgz.sj.time.ui.ManageFriendGroupActivity;
...
public class GroupListAdapter extends BaseAdapter {
    ...
    public View getView(final int groupPosition, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(timechat.fcgz.sj.time.R.layout.item_mylist, null);
            Holder = new ItemHolder();
            Holder.groupname = (TextView) convertView.findViewById(timechat.fcgz.sj.time.R.id.groupName);
            Holder.delete = (TextView) convertView.findViewById(timechat.fcgz.sj.time.R.id.delete_group);
        ...
        if(mGroupList.get(groupPosition).equals("")){
            Holder.groupname.setText(mContext.getResources().getString(timechat.fcgz.sj.time.R.string.default_group_name));
