...
public class ChatInput extends RelativeLayout implements TextWatcher,View.OnClickListener {
    ...
    public ChatInput(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(timechat.fcgz.sj.time.R.layout.chat_input, this);
        initView();
    }

    private void initView(){
        textPanel = (LinearLayout) findViewById(timechat.fcgz.sj.time.R.id.text_panel);
        btnAdd = (ImageButton) findViewById(timechat.fcgz.sj.time.R.id.btn_add);
        btnAdd.setOnClickListener(this);
        btnSend = (ImageButton) findViewById(timechat.fcgz.sj.time.R.id.btn_send);
        btnSend.setOnClickListener(this);
        btnVoice = (ImageButton) findViewById(timechat.fcgz.sj.time.R.id.btn_voice);
        btnVoice.setOnClickListener(this);
        btnEmotion = (ImageButton) findViewById(timechat.fcgz.sj.time.R.id.btnEmoticon);
        btnEmotion.setOnClickListener(this);
        morePanel = (LinearLayout) findViewById(timechat.fcgz.sj.time.R.id.morePanel);
        LinearLayout BtnImage = (LinearLayout) findViewById(timechat.fcgz.sj.time.R.id.btn_photo);
        BtnImage.setOnClickListener(this);
        LinearLayout BtnPhoto = (LinearLayout) findViewById(timechat.fcgz.sj.time.R.id.btn_image);
        BtnPhoto.setOnClickListener(this);
        LinearLayout btnVideo = (LinearLayout) findViewById(timechat.fcgz.sj.time.R.id.btn_video);
        btnVideo.setOnClickListener(this);
        LinearLayout btnFile = (LinearLayout) findViewById(timechat.fcgz.sj.time.R.id.btn_file);
        btnFile.setOnClickListener(this);
        setSendBtn();
        btnKeyboard = (ImageButton) findViewById(timechat.fcgz.sj.time.R.id.btn_keyboard);
        btnKeyboard.setOnClickListener(this);
        voicePanel = (TextView) findViewById(timechat.fcgz.sj.time.R.id.voice_panel);
        ...
        editText = (EditText) findViewById(timechat.fcgz.sj.time.R.id.input);
        ...
        emoticonPanel = (LinearLayout) findViewById(timechat.fcgz.sj.time.R.id.emoticonPanel);
    ...
    private void updateVoiceView(){
        if (isHoldVoiceBtn){
            voicePanel.setText(getResources().getString(timechat.fcgz.sj.time.R.string.chat_release_send));
            voicePanel.setBackground(getResources().getDrawable(timechat.fcgz.sj.time.R.drawable.btn_voice_pressed));
            chatView.startSendVoice();
        }else{
            voicePanel.setText(getResources().getString(timechat.fcgz.sj.time.R.string.chat_press_talk));
            voicePanel.setBackground(getResources().getDrawable(timechat.fcgz.sj.time.R.drawable.btn_voice_normal));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case timechat.fcgz.sj.time.R.id.btn_send:
                chatView.sendText();
                break;
            case timechat.fcgz.sj.time.R.id.btn_add:
                updateView(inputMode == InputMode.MORE?InputMode.TEXT:InputMode.MORE);
                break;
            case timechat.fcgz.sj.time.R.id.btn_photo:
                if(activity!=null && requestCamera(activity)){
                    chatView.sendPhoto();
                }
                break;
            case timechat.fcgz.sj.time.R.id.btn_image:
                if(activity!=null && requestStorage(activity)){
                    chatView.sendImage();
                }
                break;
            case timechat.fcgz.sj.time.R.id.btn_voice:
                if(activity!=null && requestAudio(activity)){
                    updateView(InputMode.VOICE);
                }
                break;
            case timechat.fcgz.sj.time.R.id.btn_keyboard:
                updateView(InputMode.TEXT);
                break;
            case timechat.fcgz.sj.time.R.id.btn_video:
                ...
                break;
            case timechat.fcgz.sj.time.R.id.btnEmoticon:
                updateView(inputMode == InputMode.EMOTICON?InputMode.TEXT:InputMode.EMOTICON);
                break;
            case timechat.fcgz.sj.time.R.id.btn_file:
                chatView.sendFile();
                break;
        }
    }
