...
public class NotifyDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(title)
                .setPositiveButton(timechat.fcgz.sj.time.R.string.confirm, okListener)
                .setNegativeButton(timechat.fcgz.sj.time.R.string.cancel, cancelListener == null? new DialogInterface.OnClickListener() {
                    @Override
