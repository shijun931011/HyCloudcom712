...
public class GroupInfo implements Observer {
    ...
    public static String getTypeName(String type){
        if (type.equals(GroupInfo.publicGroup)){
            return MyApplication.getContext().getString(timechat.fcgz.sj.time.R.string.public_group);
        }else if (type.equals(GroupInfo.privateGroup)){
            return MyApplication.getContext().getString(timechat.fcgz.sj.time.R.string.discuss_group);
        }else if (type.equals(GroupInfo.chatRoom)){
            return MyApplication.getContext().getString(timechat.fcgz.sj.time.R.string.chatroom);
        }
        return "";
    }
