...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        voiceIcon.setBackgroundResource(message.isSelf()? timechat.fcgz.sj.time.R.drawable.right_voice: timechat.fcgz.sj.time.R.drawable.left_voice);
    ...
    public String getSummary() {
        return MyApplication.getContext().getString(timechat.fcgz.sj.time.R.string.summary_voice);
    }
