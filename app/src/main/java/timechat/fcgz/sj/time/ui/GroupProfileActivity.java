...
import timechat.fcgz.sj.time.model.GroupInfo;
...
public class GroupProfileActivity extends FragmentActivity implements GroupInfoView, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(timechat.fcgz.sj.time.R.layout.activity_group_chat_setting);
        ...
        name = (LineControllerView) findViewById(timechat.fcgz.sj.time.R.id.nameText);
        intro = (LineControllerView) findViewById(timechat.fcgz.sj.time.R.id.groupIntro);
        LinearLayout controlInGroup = (LinearLayout) findViewById(timechat.fcgz.sj.time.R.id.controlInGroup);
        controlInGroup.setVisibility(isInGroup? View.VISIBLE:View.GONE);
        TextView controlOutGroup = (TextView) findViewById(timechat.fcgz.sj.time.R.id.controlOutGroup);
    ...
    public void showGroupInfo(List<TIMGroupDetailInfo> groupInfos) {
        ...
        LineControllerView member = (LineControllerView) findViewById(timechat.fcgz.sj.time.R.id.member);
        if (isInGroup){
        ...
        LineControllerView id = (LineControllerView) findViewById(timechat.fcgz.sj.time.R.id.idText);
        id.setContent(info.getGroupId());

        intro.setContent(info.getGroupIntroduction());
        LineControllerView opt = (LineControllerView) findViewById(timechat.fcgz.sj.time.R.id.addOpt);
        switch (info.getGroupAddOpt()){
            case TIM_GROUP_ADD_AUTH:
                opt.setContent(getString(timechat.fcgz.sj.time.R.string.chat_setting_group_auth));
                break;
            case TIM_GROUP_ADD_ANY:
                opt.setContent(getString(timechat.fcgz.sj.time.R.string.chat_setting_group_all_accept));
                break;
            case TIM_GROUP_ADD_FORBID:
                opt.setContent(getString(timechat.fcgz.sj.time.R.string.chat_setting_group_all_reject));
                break;
        }
        LineControllerView msgNotify = (LineControllerView) findViewById(timechat.fcgz.sj.time.R.id.messageNotify);
        if (GroupInfo.getInstance().isInGroup(identify)){
            switch (GroupInfo.getInstance().getMessageOpt(identify)){
                case NotReceive:
                    msgNotify.setContent(getString(timechat.fcgz.sj.time.R.string.chat_setting_no_rev));
                    break;
                case ReceiveAndNotify:
                    msgNotify.setContent(getString(timechat.fcgz.sj.time.R.string.chat_setting_rev_notify));
                    break;
                case ReceiveNotNotify:
                    msgNotify.setContent(getString(timechat.fcgz.sj.time.R.string.chat_setting_rev_not_notify));
                    break;
            }
            msgNotify.setOnClickListener(this);
            messageOptContent = new HashMap<>();
            messageOptContent.put(getString(timechat.fcgz.sj.time.R.string.chat_setting_no_rev), TIMGroupReceiveMessageOpt.NotReceive);
            messageOptContent.put(getString(timechat.fcgz.sj.time.R.string.chat_setting_rev_not_notify), TIMGroupReceiveMessageOpt.ReceiveNotNotify);
            messageOptContent.put(getString(timechat.fcgz.sj.time.R.string.chat_setting_rev_notify), TIMGroupReceiveMessageOpt.ReceiveAndNotify);
        }else{
        ...
        if (isManager()){
            ...
            allowTypeContent.put(getString(timechat.fcgz.sj.time.R.string.chat_setting_group_auth), TIMGroupAddOpt.TIM_GROUP_ADD_AUTH);
            allowTypeContent.put(getString(timechat.fcgz.sj.time.R.string.chat_setting_group_all_accept), TIMGroupAddOpt.TIM_GROUP_ADD_ANY);
            allowTypeContent.put(getString(timechat.fcgz.sj.time.R.string.chat_setting_group_all_reject), TIMGroupAddOpt.TIM_GROUP_ADD_FORBID);
            name.setCanNav(true);
            name.setOnClickListener(this);
            intro.setCanNav(true);
            intro.setOnClickListener(this);
        }
        TextView btnDel = (TextView) findViewById(timechat.fcgz.sj.time.R.id.btnDel);
        btnDel.setText(isGroupOwner ? getString(timechat.fcgz.sj.time.R.string.chat_setting_dismiss) : getString(timechat.fcgz.sj.time.R.string.chat_setting_quit));
                ...
                if (isGroupOwner){
                    GroupManagerPresenter.dismissGroup(identify, new TIMCallBack() {
                        ...
                        public void onSuccess() {
                            Toast.makeText(GroupProfileActivity.this, getString(timechat.fcgz.sj.time.R.string.chat_setting_dismiss_succ),Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                }else{
                    GroupManagerPresenter.quitGroup(identify, new TIMCallBack() {
                        ...
                        @Override
                        public void onSuccess() {
                            Toast.makeText(GroupProfileActivity.this, getString(timechat.fcgz.sj.time.R.string.chat_setting_quit_succ),Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                }
                break;
            case timechat.fcgz.sj.time.R.id.controlOutGroup:
                Intent intent = new Intent(this, ApplyGroupActivity.class);
                intent.putExtra("identify", identify);
                startActivity(intent);
                break;
            case timechat.fcgz.sj.time.R.id.member:
                ...
                break;
            case timechat.fcgz.sj.time.R.id.addOpt:
                ...
                new ListPickerDialog().show(stringList,getSupportFragmentManager(), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, final int which) {
                        TIMGroupManager.getInstance().modifyGroupAddOpt(identify, allowTypeContent.get(stringList[which]), new TIMCallBack() {
                            @Override
                            public void onError(int i, String s) {
                                Toast.makeText(GroupProfileActivity.this, getString(timechat.fcgz.sj.time.R.string.chat_setting_change_err),Toast.LENGTH_SHORT).show();
                            }
                ...
                break;
            case timechat.fcgz.sj.time.R.id.nameText:
                name.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        EditActivity.navToEdit(GroupProfileActivity.this, getString(timechat.fcgz.sj.time.R.string.chat_setting_change_group_name), name.getContent(), REQ_CHANGE_NAME, new EditActivity.EditInterface() {
                            @Override
                ...
                break;
            case timechat.fcgz.sj.time.R.id.groupIntro:
                intro.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        EditActivity.navToEdit(GroupProfileActivity.this, getString(timechat.fcgz.sj.time.R.string.chat_setting_change_group_intro), intro.getContent(), REQ_CHANGE_INTRO, new EditActivity.EditInterface() {
                            @Override
                            public void onEdit(final String text, TIMCallBack callBack) {
                ...
                break;
            case timechat.fcgz.sj.time.R.id.messageNotify:
