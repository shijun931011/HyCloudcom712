...
public class ChooseFriendActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(timechat.fcgz.sj.time.R.layout.activity_choose_friend);
        TemplateTitle title = (TemplateTitle) findViewById(timechat.fcgz.sj.time.R.id.chooseTitle);
        title.setMoreTextAction(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (selectList.size() == 0){
                    Toast.makeText(ChooseFriendActivity.this, getString(timechat.fcgz.sj.time.R.string.choose_need_one), Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        mGroupListView = (ExpandableListView) findViewById(timechat.fcgz.sj.time.R.id.groupList);
