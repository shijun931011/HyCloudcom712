...
import timechat.fcgz.sj.time.adapters.FriendManageMessageAdapter;
...
public class FriendshipManageMessageActivity extends Activity implements FriendshipMessageView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(timechat.fcgz.sj.time.R.layout.activity_friendship_manage_message);
        listView = (ListView) findViewById(timechat.fcgz.sj.time.R.id.list);
        adapter = new FriendManageMessageAdapter(this, timechat.fcgz.sj.time.R.layout.item_two_line, list);
